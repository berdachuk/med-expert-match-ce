 ...
 */
@org.springframework.modulith.ApplicationModule(allowedDependencies = {"core :: *", "doctor :: *", "medicalcase :: *", "clinicalexperience :: *", "medicalcoding :: *", "facility :: *", "graph :: *", "embedding :: *", "llm :: *"})
