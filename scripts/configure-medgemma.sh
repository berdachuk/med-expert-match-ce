...
# Embedding configuration (MedGemma does not include embeddings, use separate model)
...
# Tool calling configuration (MedGemma does not support tool calling, use FunctionGemma)
